...
if __name__ == '__main__':
    ...
    # Testing goal_test(state)
    print("Testing goal_state(state):",misscann.goal_test(initial_state))

    # Testing result(state, action)
    print("Testing result(state, action)", misscann.result(initial_state, 'MM'))

    # Testing actions(state)
    print("Testing actions(state):",misscann.actions((1,3,False)))
